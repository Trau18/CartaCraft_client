                    ...
                    if (var3.entityHit.attackEntityFrom(var22, var20))
                    {
                        if (var3.entityHit instanceof EntityLiving)
                        {
                            ...
                            if (this.knockbackStrength > 0)
                            {
                                ...
                                if (var21 > 0.0F)
                                {
                                    var3.entityHit.addVelocity(this.motionX * (double)this.knockbackStrength * 0.6000000238418579D / (double)var21, 0.1D, this.motionZ * (double)this.knockbackStrength * 0.6000000238418579D / (double)var21);
                                }
                            }
                        }
